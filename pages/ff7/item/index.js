    ...
    return (
      <div>
        ...
        <Layout routing={this.props}>
          <div {...styles.blueGrad} {...styles.finalMenu} {...styles.finalTop}>
            <span>Use</span>
          </div>
          <div {...styles.finalMenu} {...styles.blueGrad} {...styles.finalItemUsers} >
            {this.state.characters.map((character) => {
              let limit = false;
              return <Character key={character.id} character={character} limit={limit} />
            })}
          </div>
          <div  {...styles.blueGrad}  {...styles.finalMenu} {...styles.finalItems}>
            {this.renderItems()}
          </div>
        </Layout>
      </div>
